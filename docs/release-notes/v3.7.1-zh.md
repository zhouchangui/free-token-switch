...
- **ArchLinux 安装支持** (#259)
  添加 AUR 安装方式：`paru -S tokens-buddy-bin`
...
访问 [Releases](https://github.com/zhouchangui/tokens-buddy/releases/latest) 下载最新版本
...
访问 [Releases](https://github.com/zhouchangui/tokens-buddy/releases/latest) 下载：

- **Windows**：`TokensBuddy-Windows.msi` 或 `-Portable.zip`
- **macOS**：`TokensBuddy-macOS.tar.gz` 或 `.zip`
- **Linux**：`TokensBuddy-Linux.AppImage` 或 `.deb`
...
[使用 "tokens-buddy" 优惠码注册享 9 折优惠](https://www.packyapi.com/register?aff=tokens-buddy)
...
- **问题反馈**：[GitHub Issues](https://github.com/zhouchangui/tokens-buddy/issues)
- **讨论**：[GitHub Discussions](https://github.com/zhouchangui/tokens-buddy/discussions)
