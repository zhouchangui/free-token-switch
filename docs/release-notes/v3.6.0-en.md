...
**[中文更新说明 Chinese Documentation →](https://github.com/zhouchangui/tokens-buddy/blob/main/docs/release-notes/v3.6.0-zh.md)**
...
- Download `TokensBuddy-v3.6.0-macOS.zip` from [Assets](#assets) below
...
- **Installer**: `TokensBuddy-v3.6.0-Windows.msi`
- **Portable**: `TokensBuddy-v3.6.0-Windows-Portable.zip`

### Linux

- **AppImage**: `TokensBuddy-v3.6.0-Linux.AppImage`
- **Debian**: `TokensBuddy-v3.6.0-Linux.deb`
...
**Full Changelog**: https://github.com/zhouchangui/tokens-buddy/compare/v3.5.1...v3.6.0
