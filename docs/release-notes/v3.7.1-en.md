...
Visit [Releases](https://github.com/farion1231/tokens-buddy/releases/latest) to download the latest version
...
Visit [Releases](https://github.com/farion1231/tokens-buddy/releases/latest) to download:
...
- **Issues**: [GitHub Issues](https://github.com/farion1231/tokens-buddy/issues)
- **Discussions**: [GitHub Discussions](https://github.com/farion1231/tokens-buddy/discussions)
