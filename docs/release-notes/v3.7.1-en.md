...
- **ArchLinux Installation Support** (#259)
  Added AUR installation method: `paru -S tokens-buddy-bin`
...
Visit [Releases](https://github.com/zhouchangui/tokens-buddy/releases/latest) to download the latest version
...
v3.7.0 represents a shift in TokensBuddy's positioning:
...
Visit [Releases](https://github.com/zhouchangui/tokens-buddy/releases/latest) to download:

- **Windows**: `TokensBuddy-Windows.msi` or `-Portable.zip`
- **macOS**: `TokensBuddy-macOS.tar.gz` or `.zip`
- **Linux**: `TokensBuddy-Linux.AppImage` or `.deb`
- **ArchLinux**: `paru -S tokens-buddy-bin`
...
[Register with "tokens-buddy" code for 10% discount](https://www.packyapi.com/register?aff=tokens-buddy)
...
- **Issues**: [GitHub Issues](https://github.com/zhouchangui/tokens-buddy/issues)
- **Discussions**: [GitHub Discussions](https://github.com/zhouchangui/tokens-buddy/discussions)
