...
TokensBuddy は `ccswitch://` ディープリンクプロトコルをサポートしており、リンクからワンクリックで設定をインポートできます。
...
**アクセス先**：[https://farion1231.github.io/tokens-buddy/deplink.html](https://farion1231.github.io/tokens-buddy/deplink.html)
...
TokensBuddy のインストール時に `ccswitch://` プロトコルが自動登録されます。
