...
TokensBuddy 支持 `ccswitch://` 深度链接协议，可以通过链接一键导入配置。
...
**访问地址**：[https://farion1231.github.io/tokens-buddy/deplink.html](https://farion1231.github.io/tokens-buddy/deplink.html)
...
TokensBuddy 安装时会自动注册 `ccswitch://` 协议。
