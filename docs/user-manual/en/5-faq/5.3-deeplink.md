...
TokensBuddy supports the `ccswitch://` deep link protocol, enabling one-click configuration import via links.
...
**URL**: [https://farion1231.github.io/tokens-buddy/deplink.html](https://farion1231.github.io/tokens-buddy/deplink.html)
...
TokensBuddy automatically registers the `ccswitch://` protocol during installation.
