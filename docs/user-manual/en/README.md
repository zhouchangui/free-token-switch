...
| File | Description |
|------|-------------|
| [5.1-config-files.md](./5-faq/5.1-config-files.md) | TokensBuddy storage, CLI configuration file formats |
...
- Applicable to TokensBuddy v3.13.0+
