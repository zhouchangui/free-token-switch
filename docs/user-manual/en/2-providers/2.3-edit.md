...
TokensBuddy provides rich icon customization features:
...
This ensures TokensBuddy and CLI tool configurations stay in sync.
...
When adding a provider, TokensBuddy automatically extracts endpoint URLs from the configuration.
