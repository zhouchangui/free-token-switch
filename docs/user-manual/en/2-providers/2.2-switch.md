...
2. TokensBuddy updates the configuration file
...
1. Right-click the TokensBuddy icon in the system tray
...
When switching providers, TokensBuddy modifies the following files:
