...
TokensBuddy provides a smart backfill protection mechanism to ensure your manual modifications are not lost.
...
```
tokensbuddy://import/prompt?data=<base64-encoded preset>
```
