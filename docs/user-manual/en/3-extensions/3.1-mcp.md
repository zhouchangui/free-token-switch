...
When enabling an app's toggle, TokensBuddy will:
...
When disabling an app's toggle, TokensBuddy will:
...
If you have already configured MCP servers in CLI tools, you can import them into TokensBuddy:

1. Click the "Import" button
2. Select the app to import from (Claude/Codex/Gemini/OpenCode)
3. TokensBuddy reads the existing configuration and imports it
