...
const resources = {
  en: {
    translation: {
      ...
      "hero.title2": "Or Exchange Token for USTC",
      "hero.desc": ">> Whether it's Claude Pro or Gemini subscription, stop wasting it. Securely share with friends via Nostr and settle in real-time.",
      ...
      "f2.title": "USTC Value Exchange",
      "f2.desc": "Turn your unused quotas into value. Real-time settlement ensures you get paid for every token shared.",
      ...
      "terminal.recv": "Recv:",
      "terminal.recvMsg": "System online. Token sharing protocol active. How can we help today?",
      "cta.title": "Start",
      ...
      "footer.fork": "Powered by CC-Switch | Decentralized for"
    }
  },
  zh: {
    translation: {
      ...
      "hero.title2": "或者把 Token 换成 USTC",
      "hero.desc": ">> 无论是 Claude 还是 Gemini 订阅，不再被闲置。通过 Nostr 安全地向好友分享，并实现价值实时转化。",
      ...
      "f2.title": "USTC 价值转化",
      "f2.desc": "让你的闲置额度变现。实时结算系统确保你分享的每一个 Token 都能转化为实际价值。",
      "f3.title": "一键摆摊上线",
